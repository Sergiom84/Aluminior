...
// Base exclusiva para este test destructivo dentro del Postgres efímero.
// Override con TEST_DATABASE_URL.
const URL = process.env.TEST_DATABASE_URL ?? 'postgres://aluminior:aluminior@localhost:55433/aluminior_etl_test'
